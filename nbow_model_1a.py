...
### Model_1a: Same as Model_1 except don't sum the xs_'s. (STILL A TO DO...) . 
...
### Add a helper function for matrix multiplication with 3-dimensional input matrices
def matmul3d(X, W):
...
def fully_connected_layers(h0_, hidden_dims, activation=tf.tanh,
    ...
    for i, hdim in enumerate(hidden_dims):
        h_ = tf.layers.dense(h_, hdim, activation=activation, name=("Hidden_%d"%i))  #### WILL NEED TO USE matmul3d, NOT .dense?
