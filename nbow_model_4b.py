## Model_4: Incorporate GloVe embeddings as well as LIWC features, similiar to Model_3. Still training with ISOT "title"s.    
## Model_4b: Increase dropout_rate to 0.8. 

### GloVe word embeddings similar to Model_2, but additional custom LIWC features included
### Simplest version: Sum the LIWC embeddings also, then concat with summed Xs.
### Add additional liwc_features "embedding" function 
### Modify BOW_encoder
...
def BOW_encoder(ids_, ns_, V, embed_dim, hidden_dims, dropout_rate=0,
    ...
    h_ = fully_connected_layers(xc_, hidden_dims, dropout_rate=0.8, is_training=True)
